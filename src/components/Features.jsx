    ...
    <section className="features" id="features">
      ...
      <div className="features-container">
        <div className="feature-card">
          <img src="assets/images/feature1.jpg" alt="Feature 1" className="feature-icon" />
        ...
        <div className="feature-card">
          <img src="assets/images/feature2.jpg" alt="Feature 2" className="feature-icon" />
        ...
        <div className="feature-card">
          <img src="assets/images/feature3.jpg" alt="Feature 3" className="feature-icon" />
